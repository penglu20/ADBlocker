...
#define PKG(x) "com/pl/adblocker/core/" x
#define TYP(x) "L" PKG(x) ";"

#define JAVA_PACKAGE_REGISTERNATIVES(x) \
extern "C" JNIEXPORT void Java_com_pl_adblocker_core_##x##_registerNatives (JNIEnv *env, jclass clazz)\
{\
